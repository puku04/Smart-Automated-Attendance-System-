  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'sparkle-path-1': 'sparkle-path-1 1.5s linear 0.5s infinite',
        'sparkle-path-2': 'sparkle-path-2 1.5s linear 0.5s infinite',
        'sparkle-path-3': 'sparkle-path-3 1.5s linear 0.5s infinite',
      },
    },
  },
